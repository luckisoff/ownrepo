...
?>
  ...
  <section class="banner">
      ...
      <div class="row">
        <div class="brandee">
          <div class="col-md-12 text-center">
            <div class="brand">
              <a href="index.php" class="navbar-brand"><img src="assets/img/logo.png"></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="sprite">
      <img src="assets/img/firefly.png">
    </div>
    <div class="strip" style="bottom:100px;">
      <img src="assets/img/mark.png">
    </div>
    <div class="strip">
      <img src="assets/img/sep.png" style="width: 100%;">
    </div>
    <div class="rax">
    ...
    <div id="carousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="phone-buttons">
        <button class="btn btn-android"><a href="https://play.google.com/store/apps/details?id=com.thesunbi.kbcnepal"
                                           target="_blank"><i class="fa fa-android"></i>Google Play Store</a></button>
        <button class="btn btn-ios"><a href="#" target="_blank"><i class="fa fa-apple"></i>iOS App Store</a></button>
      </div>
      <!--        <div class="svg-vec">-->
          ...
          <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="cover-image-abt">
              <div class="wrap-abt-image"
                   style="background: url('assets/img/raj.jpg'); background-size: cover; background-position: 50% 50%; width: 100%; height: 300px;">
              </div>
            </div>
          </div>
          <div class="col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="video-wrap">
          ...
          <div class="col-md-12 all-own-owl">
            <div class="owl-carousel owl-theme owlern" style="padding: 70px 0px 0px 0px;">
              <div class="item">
                <div class="wrap-item"
                     style="background: url('assets/img/capture.jpg'); background-size: cover; background-position: 50% 50%;">
                    ...
                    <div class="center-owl">
                      <div class="owl-center text-center">
                        <a href="https://www.youtube.com/watch?v=OGQ5FarAufA"
                           target="_blank"><img src="assets/img/play-button.png"></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="item">
                <div class="wrap-item"
                     style="background: url('assets/img/capture1.jpg'); background-size: cover; background-position: 50% 50%;">
                  <div class="wrap-wrap-item">
                    <div class="center-owl">
                      <div class="owl-center text-center">
          ...
          <div class="col-md-12 all-own-owl">
            <div class="content-owl">
              <div class="owl-carousel owl-theme owler" style="padding: 70px 0px 0px 0px;">
                <div class="item">
                  <div class="wrap-item" data-toggle="tooltip" data-placement="bottom" title="Advertising Partner">
                    <img src="assets/img/logo3.png">
                  </div>
                </div>
                <div class="item">
                  <div class="wrap-item" data-toggle="tooltip" data-placement="bottom" title="Publication Partner">
                    <img src="assets/img/logo2.png">
                  </div>
                </div>
                <div class="item">
                  <div class="wrap-item" data-toggle="tooltip" data-placement="bottom" title="Technology Partner">
                    <img src="assets/img/logo1.png">
                  </div>
                </div>
                <div class="item">
                  <div class="wrap-item" data-toggle="tooltip" data-placement="bottom" title="Hospitality Partner">
