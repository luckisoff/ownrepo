...
Route::get('get-question-level/{user_id?}/{level?}', 'QuestionLevelController@test');
Route::get('set-played-level/{user_id}/{setid}', 'QuestionLevelController@setLevelPlayed');
